	...
	<%if (e != null) { %>
		...
		<div class="container-login100" style="background-image: url('images/cachorros.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="localidadmod" method="post">
					...
					<div class="wrap-input100 validate-input m-b-15" data-validate = "Localidad requerida">
						...
						%>						
						<option value="<%= loc.getId()%>"><%= loc.getNombre() %>, <%= loc.getProvincia() %></option> 
						<% } %>
						</select>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre requerido">
						...
						<input class="input100" type="text" name="nombre_localidad" placeholder="Ingrese nombre">						
					</div>

					<div class="wrap-input100 validate-input" data-validate="Provincia Requerida">
						<span class="label-input100">Nueva Provincia</span>
