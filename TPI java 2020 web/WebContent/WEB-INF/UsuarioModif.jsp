	...
	<%if (e != null) { %>
		...
		<div class="container-login100" style="background-image: url('images/cachorros.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="usuariomod" method="post">
					...
					<div class="wrap-input100 validate-input m-b-15" data-validate = "Email requerido">
					...
					<div class="wrap-input100 validate-input m-b-15" data-validate = "Apellido requerido">
					...
					<div class="wrap-input100 validate-input m-b-15" data-validate = "Domicilio requerido">
						<span class="label-input100">Domicilio</span>					
						<input class="input100" type="text" name="domicilio" placeholder="Ingrese su domicilio">						
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>					
					
					<div class="wrap-input100 validate-input m-b-15" data-validate = "Documento requerido">
						<span class="label-input100">Nro. de documento</span>
						<input class="input100" type="text" name="nrodoc" placeholder="Ingrese su nro. de documento">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>		
