	...
	<div class="limiter">
		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="localidadAdd"
					method="post">
					...
					<p class="text-center txt2 m-b-15">Agregar Localidad</p>

					<div class="wrap-input100 validate-input m-b-23"
						data-validate="Usuario requerido">
						<span class="label-input100">Localidad</span> <input
					...
					<div class="wrap-input100 validate-input"
						...
						<span class="label-input100">Provincia</span> <input
