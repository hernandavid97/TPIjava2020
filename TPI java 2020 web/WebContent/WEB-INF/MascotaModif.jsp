		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="mascotamod"
					...
					<p class="text-center txt2 m-b-15">Modificar Mascota</p>
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">Nuevo Nombre</span> <input
							class="input100" type="text" name="nombre_mascota"
							placeholder="Ingrese nombre">
					</div>

					<div class="wrap-input100 validate-input"
						data-validate="Color Requerido">
						<span class="label-input100">Nuevo Color</span> <input
							class="input100" type="text" name="color"
					...
					<div class="wrap-input100 validate-input"
						data-validate="Edad Requerida">
						<span class="label-input100">Nueva Edad</span> <input
							class="input100" type="number" name="edad"
							placeholder="Ingrese edad">
					</div>

					<div class="wrap-input100 validate-input"
						data-validate="Imagen Requerida">
						<span class="label-input100">Nuevas Imagenes</span> <input
							class="input100" type="text" name="imagenes"
							placeholder="Ingrese imagenes separadas por coma">
					</div>
